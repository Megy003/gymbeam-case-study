...
| Priorita | Akcia | Čas |
|----------|-------|-----|
| Okamžite | Zmeniť Output Mapping na Replace | 5 min |
| Okamžite | TRUNCATE staging tabuľky | 5 min |
| Okamžite | ANALYZE na dotknutých tabuľkách | 5 min |
| Tento týždeň | Pridať indexy | 1 hod |
| Tento týždeň | Inkrementálne spracovanie | 2 hod |
| Dlhodobé | Monitoring — alert ak >30 min | 1 deň |